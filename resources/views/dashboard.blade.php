                ...
                <div class="bg-white  border border-gray-100  shadow-md shadow-black/5 p-6 rounded-lg sm:text-base">
                    <div class="flex flex-row space-x-4 items-center border border-gray-100   p-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 font-bold text-2xl inline-flex items-center space-x-2">
                    ...
                    <div class="flex flex-row space-x-4 items-center border border-gray-100   p-6">
                        ...
                        <div>
                            <p class="text-teal-300 text-sm font-medium uppercase leading-4">Ventas {{ $nombreMesActual }}
                            </p>
                            <p class="text-gray-600 font-bold text-2xl inline-flex items-center space-x-2">
                    ...
                    <div class="flex flex-row space-x-4 items-center border border-gray-100   p-6">
                        ...
                        <div>
                            <p class="text-indigo-300 text-sm font-bold uppercase leading-4">Total Clientes </p>
                            <p class="text-gray-600 font-bold text-2xl inline-flex items-center space-x-2">
                    ...
                    <div class="flex flex-row space-x-4 items-center border border-gray-100   p-6">
                        ...
                        <div>
                            <p class="text-indigo-300 text-sm font-bold uppercase leading-4">Productos </p>
                            <p class="text-gray-600 font-bold text-2xl inline-flex items-center space-x-2">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                            @foreach ($productosVendidos as $vendido)
                                <tr class="border-b ">
                                    ...
                                    <td class="py-3 px-2">{{ $vendido->total_cantidad }} {{ $vendido->simbolo_sunat }}</td>
