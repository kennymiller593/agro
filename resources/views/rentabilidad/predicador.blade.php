    ...
    <div class="w-full ">
        <div class="bg-white shadow-md rounded p-4 ">
            ...
            <div class="flex flex-wrap items-center justify-between space-x-2 mb-4" bis_skin_checked="1">
                <div class="flex flex-col md:flex-row items-center w-full gap-4 md:space-x-2" bis_skin_checked="1">
                    <input type="date" id="date_from" name="date_from" value="{{$startDate}}"
                        class="px-2 py-1 border rounded w-full md:w-fit" placeholder="dd/mm/aaaa">
                    <input type="date" id="date_to" name="date_to" value="{{$endDate}}"
                        class="px-2 py-1 border rounded w-full md:w-fit" placeholder="dd/mm/aaaa">
                    <button id="filter-btn"
                        class="px-4 py-1 text-white bg-blue-500 rounded hover:bg-blue-600 w-full md:w-fit">Filtrar</button>
                </div>
            </div>

            <div id="content-prod" class="overflow-x-auto">
...
<script>
    window.onload = function() {
        addBgToMenuItem('finanzas_rentabilidad');
    };
</script>
@endsection